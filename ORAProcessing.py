...
#             plt.savefig(f"SynGO/Ora/Enriched/{ontologyName}{algs[0]}{algs[1]}{algs[2]}.png")
#         else:
#             # (Ab, aB, AB) for two
#             venn2(subsets=[len(geneAlg1),len(geneAlg2),overlap12], set_labels=algs)
#             plt.savefig(f"SynGO/Ora/Enriched/{ontologyName}{algs[0]}{algs[1]}.png")
#         plt.show()
#     else:
#         noAlgs = len(algs)
#         print(algs)
...
if __name__ == "__main__":
    ...
    trubetskoydf = read_csv_files("SynGO/Ora/" + list_ontologies[0])
    synapseLocationdf = read_csv_files("SynGO/Ora/" + list_ontologies[1])
    gomfiddf = read_csv_files("SynGO/Ora/" + list_ontologies[2])
    syngodf = read_csv_files("SynGO/Ora/" + list_ontologies[3])
    topontoovghdoiddf = read_csv_files("SynGO/Ora/" + list_ontologies[4])
    gobpid = read_csv_files("SynGO/Ora/" + list_ontologies[5])
    trubetskoypriordf = read_csv_files("SynGO/Ora/" + list_ontologies[6])
